...
description: Run Playwright Python scripts against ExampleCorp staging safely. Use when writing or executing a Playwright automation script for self-QA or browser testing on staging-app.example.com. Handles CF Access headers, credential injection, syntax validation before execution, and uv run wrapping — so secrets are never hardcoded in scripts.
---
