...
- **PR URL or number** — e.g., `1167` or `https://github.com/example-org/app-pos/pull/1167`
- **Linear ticket URL or ID** — e.g., `PAY-519` or `https://linear.app/example/issue/PAY-519/...`
