...
description: Use when deferring work to code or project-level storage — so items resurface when editing nearby code or starting a new session in the same project, instead of being forgotten.
---
